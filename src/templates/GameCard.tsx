    ...
    <Card sx={{backgroundColor:"#24245270",color:"#ffffff"}} className="p-2" >
        <Box  >
            <div className="flex gap-1 p-2 mb-2 bg-[#ffffff07]">
              <img src={avatarImg} alt="گرداننده" className="rounded-full" width={21} height={21} />
              <div className="text-[12px] text-[#A6A6CB]">
                  گرداننده: <span className="text-white font-medium">علیرضا رودی</span>
              </div>
            </div>

            <div className="overflow-hidden rounded-md">
              <img src={MafiaBannerImg} alt="event banner" width={170} height={136} />
            </div>
        </Box>
        ...
        <Box>
          ...
          <Typography fontSize={10} className="text-[#A6A6CB]">ساعت ۲۳:۲۰ ـ ۱۸ فروردین</Typography>
          </div>
          <Stack className="my-4">
            <Typography component={"h3"} fontSize={12} fontWeight={800}
              style={{margin:"10ox "}}
